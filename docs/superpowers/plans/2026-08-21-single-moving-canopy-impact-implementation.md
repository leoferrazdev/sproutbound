...
- [x] **Step 1: Atualizar o teste para exigir faixa móvel única**
...
- [x] **Step 2: Rodar o teste para confirmar RED**
...
- [x] **Step 1: Implementar a geração condicional mínima**
...
- [x] **Step 1: Escrever o teste falho para impacto físico-estatal**
...
- [x] **Step 3: Implementar o estado transitório mínimo**
...
- [x] **Step 1: Escrever o teste falho do deslocamento visual**
...
- [x] **Step 3: Implementar o deslocamento visual mínimo**
...
- [x] **Step 1: Atualizar as regras do README**
...
- [x] **Step 2: Atualizar a matriz de QA**
...
- [x] **Step 3: Conferir a documentação por busca**
...
- [x] **Step 4: Commitar a documentação**
...
- [x] **Step 4: Marcar este plano como concluído e commitar**
...
- [x] **Step 5: Fazer push e verificar a referência remota**
