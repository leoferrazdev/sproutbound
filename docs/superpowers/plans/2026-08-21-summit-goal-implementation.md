...
- [x] Step 3: Implementar o marco e a derivação.
...
- [x] Step 1: Escrever teste RED de chegada.
...
- [x] Step 3: Implementar a transição.
...
- [x] Step 1: Escrever testes RED de contrato da UI.
...
- [x] Step 3: Implementar o cartão final reutilizável.
...
- [x] Step 3: Rodar git diff --check e verificar status.
